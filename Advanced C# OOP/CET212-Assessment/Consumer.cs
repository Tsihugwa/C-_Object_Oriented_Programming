...
namespace CET212_Assessment
{
	...
	public class Consumer
	{
		...
		private JourneyList journeyList; // List of candidates which will be added to
		...
		public Consumer(string id, PCQueue pcQueue, JourneyList journeyList, ProgressManager progManager)
		{
			this.id = id;
