...
namespace CET212_Assessment
{
    class Producer
    {
		...
		private IJourneyFileReader IOhandler; // File handler for reading data
		...
		public Producer(string id, PCQueue pcQueue, ConfigData configFile, IJourneyFileReader IOhandler)
		{
			this.id = id;
